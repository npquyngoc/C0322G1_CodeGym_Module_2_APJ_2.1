package James.Course_3_Array_And_Method_In_Java.Practice.P3_FindLargestElementsInArray;
...
public class FindLargestElementsInArray {
    ...
    public static void main(String[] args) {
        ...
        int largestElement = array[0], position = 0;
        ...
        System.out.println("\n■ The largest element in the array is " + largestElement + " at position " + position);
